  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-b from-[#1A1F2C] to-[#403E43]">
      <div className="relative">
        ...
        <div className="text-6xl font-bold text-center relative">
          ...
          <div className="absolute -inset-10 border border-white/10 rounded-xl animate-[pulse_2s_infinite]" />
          <div className="absolute -inset-20 border border-white/5 rounded-2xl animate-[pulse_3s_infinite]" />
        </div>
      </div>
    </div>
  );
